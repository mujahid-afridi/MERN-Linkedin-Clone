...
function Login() {
  ...
  return (
      <div className="h-screen flex flex-col items-center">
          ...
          <form action="" onSubmit={handleSignIn} className="w-full max-w-[550px] bg-white md:shadow-2xl flex flex-col  gap-[10px] px-[20px] py-[30px] rounded-md" >
              <h1 className="font-semibold text-3xl mb-[20px]">Login</h1>
              ...
              <button className=" p-[10px] bg-blue-500 rounded-xl text-white" disabled={loading}>{loading ? "Loading..." : "Login"}</button>
              <p className="w-full text-center">Already have an account? <span className="text-blue-500 cursor-pointer" onClick={()=> navigate('/signup')}>SignUp</span></p>
          </form>
      </div>
    )
}
