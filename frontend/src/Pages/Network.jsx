...
function Network() {
    ...
    let handleAcceptRequest = async(connectionId)=>{
        try{
           ...
           { requests.map((request)=> {
                return <div className='w-full md:max-w-[60%] p-[10px] h-[100px] bg-white rounded-md flex justify-between items-center'>
                    ...
                    <div className='flex gap-[20px] items-center'>
                        <TiTickOutline className='border-2 rounded-full text-green-400 text-2xl cursor-pointer' onClick={()=> handleAcceptRequest(request._id)} />
