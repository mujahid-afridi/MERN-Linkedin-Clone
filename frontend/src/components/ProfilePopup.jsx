...
function ProfilePopup() {
  ...
  return <div className='p-[10px] flex flex-col justify-center gap-[10px] w-[200px] min-h-[250px] bg-white absolute top-[50px] right-0  rounded-lg shadow-lg'>
    <div className='flex flex-col justify-center gap-[10px]'>
        ...
        <button className='w-full border-2 border-blue-400 text-blue-400 text-center p-[5px] rounded-full cursor-pointer' onClick={()=> navigate("/profile")}>View Profile</button>
    </div>
